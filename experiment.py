...
def masking_experiment(dataset, temperature=0.1):
    ...
    with open(f'./masked-papers-completions-temperature-{T}.jsonl', 'a') as f:
...
if __name__ == "__main__":
    ...
    masking_experiment(MASKED_PAPER_DATASET_30)
